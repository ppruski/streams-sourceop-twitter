...
#ifndef BEJWRMSW2KUMTKAEADRGDAS_H_
#define BEJWRMSW2KUMTKAEADRGDAS_H_
...
public:
    ...
    SELF() : Tuple() {}
    SELF(const Self & ot) : Tuple(), text_(ot.text_) 
      { constructPayload(ot); }
    SELF(const text_type & _text) : Tuple(), text_(_text) { }
...
#undef SELF
#endif // BEJWRMSW2KUMTKAEADRGDAS_H_ 
